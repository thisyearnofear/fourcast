 ...
 */
export function generate_batched_call_payload_wasm(script) {
    const ptr0 = passArray8ToWasm0(script, wasm.__wbindgen_malloc);
    const len0 = WASM_VECTOR_LEN;
    const ret = wasm.generate_batched_call_payload_wasm(ptr0, len0);
    if (ret[3]) {
...
export class CallArgument {
     ...
     */
    borrow() {
        const ret = wasm.callargument_borrow(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CallArgument.__wrap(ret[0]);
    }
    /**
     * @returns {CallArgument}
     */
    borrowMut() {
        const ret = wasm.callargument_borrowMut(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CallArgument.__wrap(ret[0]);
     ...
     */
    copy() {
        const ret = wasm.callargument_copy(this.__wbg_ptr);
        if (ret[2]) {
            throw takeFromExternrefTable0(ret[1]);
        }
        return CallArgument.__wrap(ret[0]);
...
export class TransactionComposer {
    ...
    generate_batched_calls(with_metadata) {
        const ptr = this.__destroy_into_raw();
        const ret = wasm.transactioncomposer_generate_batched_calls(ptr, with_metadata);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
     ...
     * @returns {string}
     */
    store_module(module_bytes) {
        let deferred3_0;
        let deferred3_1;
        try {
            const ptr0 = passArray8ToWasm0(module_bytes, wasm.__wbindgen_malloc);
            const len0 = WASM_VECTOR_LEN;
            const ret = wasm.transactioncomposer_store_module(this.__wbg_ptr, ptr0, len0);
            var ptr2 = ret[0];
            var len2 = ret[1];
            if (ret[3]) {
                ptr2 = 0; len2 = 0;
    ...
    add_batched_call(module, _function, ty_args, args) {
        ...
        const ret = wasm.transactioncomposer_add_batched_call(this.__wbg_ptr, ptr0, len0, ptr1, len1, ptr2, len2, ptr3, len3);
        if (ret[3]) {
            throw takeFromExternrefTable0(ret[2]);
        }
...
function __wbg_get_imports() {
    ...
    imports.wbg.__wbg_callargument_unwrap = function(arg0) {
        const ret = CallArgument.__unwrap(arg0);
        return ret;
    };
...
async function __wbg_init(module_or_path) {
    ...
    if (typeof module_or_path === 'undefined') {
        module_or_path = new URL('aptos_dynamic_transaction_composer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
