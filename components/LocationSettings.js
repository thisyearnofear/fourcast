...
export default function LocationSettings({ isOpen, onClose, isNight, currentLocationName }) {
 ...
 className={`relative max-w-md w-full p-6 border border-white/10 bg-black/40`}
 >
 ...
 className={`w-full text-left p-4 border transition-all ${mode === 'random' ? 'border-purple-400/50 bg-purple-500/10' : 'border-white/10 bg-white/5 hover:bg-white/10'}`}
 >
 ...
 className={`w-full text-left p-4 border transition-all ${mode === 'manual' ? 'border-purple-400/50 bg-purple-500/10' : 'border-white/10 bg-white/5 hover:bg-white/10'}`}
 >
 ...
 className="w-full px-4 py-2.5 bg-white/10 border border-white/20 text-white text-sm placeholder-white/25 outline-none focus:border-purple-400/50 transition-colors"
 autoFocus
 />
 )}
 ...
 className={`w-full text-left p-4 border transition-all ${mode === 'geolocation' ? 'border-purple-400/50 bg-purple-500/10' : 'border-white/10 bg-white/5 hover:bg-white/10'}`}
 >
 ...
 <button
 onClick={onClose}
 className="flex-1 px-4 py-2 border border-white/10 text-white/50 text-sm hover:text-white/70 hover:bg-white/5 transition-all"
 >
 Cancel
 </button>
 <button
 ...
 className="flex-1 px-4 py-2 bg-purple-500/20 border border-purple-400/30 text-purple-200 text-sm hover:bg-purple-500/30 transition-all disabled:opacity-30"
 >
 Save & Reload
 </button>
 </div>
