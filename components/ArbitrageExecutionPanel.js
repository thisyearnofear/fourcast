...
export function ArbitrageExecutionPanel({ opportunity, onClose, isNight }) {
 ...
 className={`${cardBg} w-full max-w-5xl h-[80vh] shadow-2xl flex flex-col overflow-hidden border ${borderColor}`}
 >
 ...
 <button 
 onClick={onClose}
 className={`px-4 py-2 text-sm border ${borderColor} hover:opacity-80 transition-all ${textColor}`}
 >
 Close
 </button>
 </div>
