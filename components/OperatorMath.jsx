...
export default function OperatorMath({ compact = false }) {
 ...
 className={`mc-panel ${compact ? 'mb-4 p-4' : 'mb-6 p-5'} border border-emerald-400/20 bg-emerald-500/[0.04]`}
 >
 <div className="flex items-start gap-3">
 <div className="flex h-9 w-9 shrink-0 items-center justify-center border border-emerald-400/30 bg-emerald-500/10">
 ...
 <span className="inline-flex items-center gap-1 border border-emerald-400/30 bg-emerald-500/10 px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider text-emerald-100">
 ...
 className="inline-flex items-center gap-1.5 border border-emerald-400/40 bg-emerald-500/15 px-3 py-1.5 text-[11px] font-semibold uppercase tracking-wider text-emerald-100 transition-colors hover:bg-emerald-500/25"
