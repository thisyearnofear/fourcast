...
export function BuilderStats({ isNight = false }) {
 ...
 const badgeBg = 'bg-[var(--color-evidence)]/20';
 const badgeText = 'text-[var(--color-evidence)]';
 ...
 <div className="w-3 h-3 bg-current opacity-50 animate-pulse" />
 ...
 <div className={`${badgeBg} border border-[var(--color-evidence)]/30 p-3`}>
 ...
 <p className={`text-xs text-[var(--color-evidence)]/70 mt-1`}>
