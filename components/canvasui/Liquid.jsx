...
// canvas-ui Liquid — copied from https://canvasui.dev/docs/components/liquid
...
//
// Usage: wrap any element to add a pointer-driven fluid simulation that
// stirs up over the live content. Tasteful defaults tuned for the
// ReasoningVisualizer backdrop: emerald-leaning tint, low intensity, low
// blend so the live HTML stays readable.
...
function createLiquid(elements, options = {}) {
  ...
  function releaseAll() {
    [velocity.read, velocity.write, dye.read, dye.write, pressure.read, pressure.write, divergence, curl].forEach((t) => {
