...
export default function EvidenceBlock({
 ...
 <div
 key={idx}
 className={`flex items-center justify-between text-xs px-3 py-2 bg-white/[0.04]`}
 >
 ...
 <div className={`text-xs ${textColor} opacity-80 leading-relaxed px-3 py-2 bg-white/[0.04]`}>
 {confidenceMethod}
 </div>
 </div>
