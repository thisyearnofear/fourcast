...
export default function StatusBadge() {
  ...
  return (
    <Link
      ...
      className={`hidden md:inline-flex items-center gap-1.5 rounded-lg border border-white/10 bg-white/5 px-2.5 py-1.5 text-[11px] font-medium transition-colors hover:bg-white/10 ${c.text}`}
    >
