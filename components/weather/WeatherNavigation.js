...
export default function WeatherNavigation({ isNight }) {
 ...
 <div className={`-md border px-6 py-3 transition-colors duration-300 ${bgColor}`}>
 <div className="flex items-center space-x-6 sm:space-x-8">
 <button
 onClick={() => window.location.href = '/markets'}
 className={`flex items-center space-x-2 px-2 sm:px-3 py-2 transition-colors ${textColor} ${hoverBg}`}
 >
