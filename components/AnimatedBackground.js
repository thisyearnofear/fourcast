...
export default function AnimatedBackground({ isNight = true, timeOfDay = 'day' }) {
 ...
 <div className="absolute top-0 left-1/4 w-96 h-96 bg-gradient-to-br from-blue-500/10 to-purple-500/10 mix-blend-screen filter blur-3xl animate-blob" />
 <div className="absolute top-1/3 right-1/4 w-96 h-96 bg-gradient-to-br from-purple-500/10 to-pink-500/10 mix-blend-screen filter blur-3xl animate-blob animation-delay-2000" />
 <div className="absolute bottom-0 left-1/2 w-96 h-96 bg-gradient-to-br from-pink-500/10 to-blue-500/10 mix-blend-screen filter blur-3xl animate-blob animation-delay-4000" />
 </div>
