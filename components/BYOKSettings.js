...
export default function BYOKSettings() {
 ...
 return (
 <div className="byok-settings-container max-w-md mx-auto p-6 bg-gray-800 border border-gray-700">
 ...
 <label className="flex items-center p-3 bg-gray-700 border border-gray-600 hover:border-gray-500 transition-colors">
 <input
 type="radio"
 name="ai-provider"
 value="venice"
 ...
 <label className={`flex items-center p-3 bg-gray-700 border transition-colors ${
 ...
 />
 <div className="w-11 h-6 bg-gray-700 peer-focus:outline-none peer-focus:ring-4 peer-focus:ring-blue-800 peer peer-checked:after:translate-x-full peer-checked:after:border-white after:content-[''] after:absolute after:top-[2px] after:left-[2px] after:bg-white after:border-gray-300 after:border after: after:h-5 after:w-5 after:transition-all peer-checked:bg-blue-600"></div>
 ...
 className="w-full px-3 py-2 bg-gray-600 border border-gray-500 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500"
 />
 ...
 className="px-4 py-2 bg-gray-600 hover:bg-gray-500 text-white text-sm font-medium transition-colors disabled:opacity-50"
 >
 Test Connection
 </button>
 </div>
 ...
 onClick={handleSave}
 disabled={isSaving}
 className="flex-1 px-4 py-2 bg-blue-600 hover:bg-blue-700 text-white font-medium transition-colors disabled:opacity-50"
 >
 ...
 {/* Hackathon Demo Note */}
 <div className="mt-6 p-4 bg-purple-900/20 border border-purple-800">
