...
describe('MarketTypeDetector', () => {
  ...
  describe('International Soccer', () => {
    test('detects Spanish La Liga futures', () => {
      const market = {
        title: 'Will Barcelona win La Liga 2027?',
    ...
    test('detects Premier League futures', () => {
      const market = {
        ...
        description: 'Resolves at end of 2026-27 season',
        resolutionDate: '2027-05-24',
  ...
  describe('Other Sports', () => {
    test('detects NBA championship futures', () => {
      const market = {
        title: 'Will the Lakers win the NBA Championship 2027?',
        resolutionDate: '2027-06-15',
    ...
    test('detects MLB World Series futures', () => {
      const market = {
        ...
        description: 'Resolves after 2026 World Series',
