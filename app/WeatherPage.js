      ...
      <div className="relative z-10 flex flex-col flex-grow p-4 sm:p-6">
        ...
        {weatherData && !isLoading && (
          <div className="absolute bottom-8 left-1/2 transform -translate-x-1/2 z-20">
            <div className={`backdrop-blur-md border rounded-full px-6 py-3 transition-all duration-300 ${
              isNight 
              ...
              <div className="flex items-center space-x-6 sm:space-x-8">
                <button
                  ...
                  className={`flex items-center space-x-2 px-2 sm:px-3 py-2 rounded-lg transition-all hover:scale-110 ${
                    isNight 
                ...
                <button
                 ...
                 >
                  ...
                  <span className="text-xs sm:text-sm font-light hidden xs:inline">AI Edge</span>
                </button>
              </div>
            </div>
          </div>
